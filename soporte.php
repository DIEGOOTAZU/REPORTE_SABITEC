    ...
    <main class="container support-container">
        ...
        <div class="ticket-section">
            ...
            <div class="check-ticket">
                ...
                <form action="verificar_ticket.php" method="POST">
                    <label for="email">Email</label>
                    <input type="email" id="email" name="email" placeholder="Ingrese su email" required>
                    <label for="ticket_id">ID Ticket</label>
                    <input type="text" id="ticket_id" name="ticket_id" placeholder="Ingrese su ID de Ticket" required>

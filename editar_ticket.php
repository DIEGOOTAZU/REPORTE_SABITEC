...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $update_sql = "UPDATE tickets SET fecha = ?, estado = ?, nombre = ?, tecnico = ?, departamento = ?, asunto = ?, problema = ?, solucion = ?, tiempo_solucion = ? WHERE id = ?";
    $stmt = $conn->prepare($update_sql);
    $stmt->bind_param("sssssssssi", $fecha, $estado, $nombre, $tecnico, $departamento, $asunto, $mensaje, $solucion, $tiempo_solucion, $id);
        ...
        <div class="form-container">
            ...
            <form action="" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="departamento" name="departamento" value="<?php echo $ticket['departamento']; ?>" required>
                </div>
                <div class="mb-3">
